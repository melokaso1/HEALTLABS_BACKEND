...
{
    private readonly GetAllCargoUseCase _getAll;
    private readonly GetCargoByIdUseCase _getById;
    private readonly CreateCargoUseCase _create;
    private readonly UpdateCargoUseCase _update;
    private readonly DeleteCargoUseCase _delete;

    public CargosController(GetAllCargoUseCase getAll, GetCargoByIdUseCase getById,
        CreateCargoUseCase create, UpdateCargoUseCase update, DeleteCargoUseCase delete)
