...
using Application.UseCases.Empleado;
...
{
    private readonly EmpleadoCrudUseCase _useCase;

    public EmpleadosController(EmpleadoCrudUseCase useCase) => _useCase = useCase;
