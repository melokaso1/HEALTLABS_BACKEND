...
using Application.UseCases.Empleados;
...
{
    private readonly GetAllEmpleadoUseCase _getAll;
    private readonly GetEmpleadoByIdUseCase _getById;
    private readonly CreateEmpleadoUseCase _create;
    private readonly UpdateEmpleadoUseCase _update;
    private readonly DeleteEmpleadoUseCase _delete;

    public EmpleadosController(GetAllEmpleadoUseCase getAll, GetEmpleadoByIdUseCase getById,
        CreateEmpleadoUseCase create, UpdateEmpleadoUseCase update, DeleteEmpleadoUseCase delete)
